 ...
 */
@Controller
@RequestMapping("/CorrectionAndTreatment/correct1")
public class DbMindCorrectEndController extends BaseController
{
    private String prefix = "CorrectionAndTreatment/correct1";
