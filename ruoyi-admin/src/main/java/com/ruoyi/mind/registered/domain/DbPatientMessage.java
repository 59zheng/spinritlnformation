...
public class DbPatientMessage extends BaseEntity {
     ...
     * 是否急性期(1急性期)
     */
    @Excel(name = "是否急性期(1急性期)")
    private String isAcutePhase;
    ...
    public void setIsAcutePhase(String isAcutePhase) {
        this.isAcutePhase = isAcutePhase;
    }

    public String getIsAcutePhase() {
        return isAcutePhase;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("isAcutePhase", getIsAcutePhase())
                .toString();
    }
}